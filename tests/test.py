...
from tests.test_base import BaseTest
   ...
   def test_go_to_page_call(self):
      """Тест проверяет, что в шапке сайта кнопка "Позвонить" переводит на страницу START_URL + '.../'"""
      self.authPage = AuthPage(self.driver)
   ...
   def test_go_to_page_my_labirint_without_authorization(self):
      """Тест проверяет, что в шапке сайта кнопка "Мой лабиринт" открывает форму регистрации 'Полный доступ к Лабиринту'"""
      self.authPage = AuthPage(self.driver)
   ...
   def test_go_to_page_messages_without_authorization(self):
      """Тест проверяет, что в шапке сайта кнопка "Сообщения" открывает форму регистрации 'Полный доступ к Лабиринту'"""
      self.authPage = AuthPage(self.driver)
   ...
   def test_displayed_heder_messages(self):
      """Тест проверяет присутствие кнопкии и конки "Сообщения" на странице, видимость элемента на экране"""
      self.authPage = AuthPage(self.driver)
   ...
   def test_displayed_heder_my_labirint(self):
      """Тест проверяет присутствие кнопки и иконки "Мой Лабиринт" на странице, видимость элемента на экране"""
      self.authPage = AuthPage(self.driver)
   ...
   def test_displayed_heder_putorder(self):
      """Тест проверяет присутствие кнопки и иконки "Отложено" на странице, видимость элемента на экране"""
      self.authPage = AuthPage(self.driver)
      assert self.authPage.element_are_present(
   ...
   def test_displayed_heder_cart(self):
      """Тест проверяет присутствие кнопки и иконки "Корзина" на странице, видимость элемента на экране"""
      self.authPage = AuthPage(self.driver)
      assert self.authPage.element_are_present(
   ...
   def test_pop_up_window_putorder(self):
      """Тест проверяет, что при наведении на кнопку "Отложено" появляется всплывающее окно"""
      self.authPage = AuthPage(self.driver)
   ...
   def test_pop_up_window_cart(self):
      """Тест проверяет, что при наведении на кнопку "Корзина" появляется всплывающее окно"""
      self.authPage = AuthPage(self.driver)
      # проверяем, что элемент присутствует на странице и не виден
   ...
   def test_pop_up_window_messages(self):
      """Тест проверяет, что при наведении на кнопку "Сообщения" появляется всплывающее окно"""
      self.authPage = AuthPage(self.driver)
      # проверяем, что элемент присутствует на странице и не виден
   ...
   def test_pop_up_window_my_labirint(self):
      """Тест проверяет, что при наведении на кнопку "Мой лабиринт" появляется всплывающее окно"""
      self.authPage = AuthPage(self.driver)
      # проверяем, что элемент присутствует на странице и не виден
   ...
   def test_pop_up_window_call(self):
      """Тест проверяет, что при наведении на кнопку "Позвонить" появляется всплывающее окно"""
      self.authPage = AuthPage(self.driver)
      # проверяем, что элемент присутствует на странице и не виден
   ...
   def test_add_to_cart_method_1(self):
      """Тест проверяет, что нажатие на кнопку "Корзина" в карточке товара добавлет товар в корзину, а нажатие
   ...
   def test_add_to_cart_method_2(self):
      """Тест проверяет, что нажатие на кнопку "Корзина" в карточке товара добавлет товар в корзину"""
      self.authPage = AuthPage(self.driver)
   ...
   def test_add_to_cart_method_3(self):
      """Тест проверяет, что нажатие на кнопку "Корзина" в карточке товара добавлет товар в корзину, нажатие
   ...
   def test_start_page_add_to_favorites(self):
      """Тест проверяет возможность добавить книгу в избранное"""
      self.authPage = AuthPage(self.driver)
